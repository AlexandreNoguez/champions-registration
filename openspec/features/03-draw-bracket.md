...
- Em Futmesa e Flaflu, cada inscrição representa uma dupla no chaveamento, exibindo aluno principal e parceiro como um único competidor.
...
- As chaves de Futmesa e Flaflu mostram as duplas nas partidas e no campeão.
